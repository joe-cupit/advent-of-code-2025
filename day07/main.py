...
with open("day07/example_input.txt", "r") as f:
    example_input = [line for line in f.readlines()]

with open("day07/example_output.json", "r") as f:
    example_output = json.load(f)

with open("day07/puzzle_input.txt", "r") as f:
